...
PairStyle(coul/dsfcubl,PairCoulCubLDSF)


#else

#ifndef LMP_PAIR_COUL_CUBL_DSF_H
#define LMP_PAIR_COUL_CUBL_DSF_H

#include "pair.h"

namespace LAMMPS_NS {

class PairCoulCubLDSF : public Pair {
 public:
  PairCoulCubLDSF(class LAMMPS *);
  ~PairCoulCubLDSF();
