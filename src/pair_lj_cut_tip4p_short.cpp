...
#include "pair_lj_cut_tip4p_short.h"
...
PairLJCutTIP4PShort::PairLJCutTIP4PShort(LAMMPS *lmp) :
...
PairLJCutTIP4PShort::~PairLJCutTIP4PShort()
{
...
void PairLJCutTIP4PShort::compute(int eflag, int vflag)
{
...
void PairLJCutTIP4PShort::settings(int narg, char **arg)
{
...
void PairLJCutTIP4PShort::init_style()
{
...
double PairLJCutTIP4PShort::init_one(int i, int j)
{
...
void PairLJCutTIP4PShort::write_restart_settings(FILE *fp)
{
...
void PairLJCutTIP4PShort::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairLJCutTIP4PShort::compute_newsite(double *xO, double *xH1,
...
void *PairLJCutTIP4PShort::extract(const char *str, int &dim)
{
  dim = 0;
...
double PairLJCutTIP4PShort::memory_usage()
{
