...
#include "compute_displace_atom_cleav.h"
...
ComputeDisplaceAtomCleav::ComputeDisplaceAtomCleav(LAMMPS *lmp, int narg, char **arg) :
...
ComputeDisplaceAtomCleav::~ComputeDisplaceAtomCleav()
{
...
void ComputeDisplaceAtomCleav::init()
{
...
void ComputeDisplaceAtomCleav::compute_peratom()
{
...
void ComputeDisplaceAtomCleav::set_arrays(int i)
{
  double **xoriginal = fix->astore;
  double **x = atom->x;
  xoriginal[i][0] = x[i][0];
...
void ComputeDisplaceAtomCleav::refresh()
{
  if (atom->nmax > nvmax) {
    nvmax = atom->nmax;
    memory->destroy(varatom);
...
double ComputeDisplaceAtomCleav::memory_usage()
{
