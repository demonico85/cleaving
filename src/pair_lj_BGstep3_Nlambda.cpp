...
#include <stdlib.h>
#include <string.h>
#include "pair_lj_BGstep3_Nlambda.h"
#include "atom.h"
#include "comm.h"
#include "force.h"
#include "neighbor.h"
...
PairLJBGNlStep3::PairLJBGNlStep3(LAMMPS *lmp) : Pair(lmp)
{
  single_enable = 1;
  respa_enable  = 0;
  manybody_flag = 0;
...
PairLJBGNlStep3::~PairLJBGNlStep3()
{
  if (allocated) {
...
void PairLJBGNlStep3::compute(int eflag, int vflag)
{
...
void PairLJBGNlStep3::write_restart(FILE *fp)
{
...
void PairLJBGNlStep3::read_restart(FILE *fp)
{
...
void  PairLJBGNlStep3::write_restart_settings(FILE *fp)
{
...
void  PairLJBGNlStep3::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
void PairLJBGNlStep3::settings(int narg, char **arg)
{
...
void PairLJBGNlStep3::coeff(int narg, char **arg)
{
  if (narg < 4 || narg > 8)
...
void PairLJBGNlStep3::write_data(FILE *fp)
{
...
void PairLJBGNlStep3::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
double PairLJBGNlStep3::init_one(int i, int j)
{
...
void PairLJBGNlStep3::init_style()
{
...
double PairLJBGNlStep3::single(int i, int j, int itype, int jtype, double rsq,
