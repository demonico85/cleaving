...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(lj/cut/tip4p/short,PairLJCutTIP4PShort);
// clang-format on
#else

#ifndef LMP_PAIR_LJ_CUT_TIP4P_SHORT_H
#define LMP_PAIR_LJ_CUT_TIP4P_SHORT_H

#include "pair_lj_cut_coul_long.h"

namespace LAMMPS_NS {

class PairLJCutTIP4PShort : public PairLJCutCoulLong {
 public:
  PairLJCutTIP4PShort(class LAMMPS *);
  ~PairLJCutTIP4PShort() override;
