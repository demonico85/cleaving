...
real*8 :: AA,AB,totinteraction,N,lambda,delta,CC,DD,expn,lam,minlam,Av,StdDev 
...
!            & intermatrix(4,8) + intermatrix(4,9) + intermatrix(5,6) + intermatrix(5,7)
    ...
    CC = intermatrix(2,6) + intermatrix(3,8)  + intermatrix(4,9) + &
            intermatrix(2,3) + intermatrix(2,4) + intermatrix(3,5) + intermatrix(4,5) + intermatrix(5,7) 
        

    DD = intermatrix(3,9) + intermatrix(4,7)
    ...
    kk=kk+1
    write(20,*)kk,CC,DD,CC+DD,lambda
