...
PairStyle(lj/cleavcutcublint,PairLJCleavCutCubLInt)

#else

#ifndef LMP_PAIR_LJ_CLVCUTCUBL_INT_H
#define LMP_PAIR_LJ_CLVCUTCUBL_INT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairLJCleavCutCubLInt : public Pair {
 public:
  PairLJCleavCutCubLInt(class LAMMPS *);
  virtual ~PairLJCleavCutCubLInt();
