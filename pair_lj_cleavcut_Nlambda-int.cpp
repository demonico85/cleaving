...
#include <stdlib.h>
#include <string.h>
#include "pair_lj_cleavcut_Nlambda-int.h"
#include "atom.h"
#include "comm.h"
#include "force.h"
#include "neighbor.h"
...
// at the beginning at the simulation
    ...
    npow =  force->numeric(FLERR,arg[4]);

    rspace = force->numeric(FLERR,arg[5]);
...
void PairLJCleavCutNLInt::calculate_int_coefficients()
{
